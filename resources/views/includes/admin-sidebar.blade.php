<div class="off-canvas position-left reveal-for-large nav" id="offCanvas" data-off-canvas>
   ...
   <ul class="vertical menu">
      ...
      <li><a href="<?php echo getenv('URL_ROOT'); ?>/admin/product/create"><i class="fa fa-plus fa-fw" aria-hidden="true"></i>&nbsp; Add Product</a></li>
      <li><a href="<?php echo getenv('URL_ROOT'); ?>/admin/products"><i class="fa fa-edit fa-fw" aria-hidden="true"></i>&nbsp; Manage Product</a></li>
